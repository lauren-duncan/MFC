...
"patch_icpp(4)%alter_patch(1)": "T",  # surrounded by patch 1
"patch_icpp(4)%alpha(1)": 0.4,       # existing liquid 1
"patch_icpp(4)%alpha(2)": 0.3,       # existing liquid 2 or gas
"patch_icpp(4)%alpha(3)": 0.2,       # existing liquid 3
"patch_icpp(4)%alpha(4)": 0.1,       # new liquid
