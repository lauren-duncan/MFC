    ...
    json.dumps(
        {
            ...
            "patch_icpp(2)%alpha_rho(2)": (1.0 - alf) * 1.0,
           ...
           ### Patch 3 -- small ring, inner ring
            ...
            "patch_icpp(3)%alpha_rho(1)": 0,
            "patch_icpp(3)%alpha_rho(2)": 0,
            "patch_icpp(3)%alpha_rho(3)": (1.0 - vf0) * 1.0,
            "patch_icpp(3)%alpha_rho(4)": 0,
            "patch_icpp(3)%alpha(1)": 0,
            "patch_icpp(3)%alpha(2)": 0,
            "patch_icpp(3)%alpha(3)": vf0,
            "patch_icpp(3)%alpha(4)": 0,
            ...
            "patch_icpp(4)%radius": 0.4,
            "patch_icpp(4)%alter_patch(1)": "T",
            "patch_icpp(4)%alter_patch(2)": "T",
            "patch_icpp(4)%alter_patch(3)": "T",
            "patch_icpp(4)%alpha_rho(1)": 0,
            "patch_icpp(4)%alpha_rho(2)": 0,
            "patch_icpp(4)%alpha_rho(3)": 0,
            "patch_icpp(4)%alpha_rho(4)": (1.0 - vf0) * 1.0,
            "patch_icpp(4)%alpha(1)": 0,
            "patch_icpp(4)%alpha(2)": 0,
            "patch_icpp(4)%alpha(3)": 0,
            "patch_icpp(4)%alpha(4)": vf0,
            "patch_icpp(4)%vel(1)": 0.00,
            "patch_icpp(4)%vel(2)": 0.00,
