...
contains
    ...
    elemental function f_cpbw_KM(fR0, fR, fV, fpb)
        ...
        if (.not. f_is_default(Cau_inv)) f_cpbw_KM = f_cpbw_KM - (Cau_inv/2)*(5._wp - 4._wp*(fR0/fR) - (fR0/fR)**4._wp)
    ...
    elemental function f_rddot_KM(fpbdot, fCp, fCpbw, fRho, fR, fV, fR0, fC)
        ...
        if (.not. f_is_default(Cau_inv)) cdot_star = cdot_star - Cau_inv*2._wp*(fV/fR*(fR0/fR + (fR0/fR)**4._wp))
